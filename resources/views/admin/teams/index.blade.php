...
@section('content')
  @include('admin.teams.list_records')
@endsection
    ...
    $(document).ready(function () {
      ...
      $('body').on('click', 'a#objectEdit', function (e) {
        ...
        $.get( actionUrl +'/' +object_id+'/edit', function (res) {
          ...
          form.find('#position').val(res.data.position);
          form.find('#facebook').val(res.data.facebook);
          form.find('#twitter').val(res.data.twitter);
          form.find('#linkedin').val(res.data.linkedin);
